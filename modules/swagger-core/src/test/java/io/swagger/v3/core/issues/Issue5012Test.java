...
public class Issue5012Test {
    ...
    public void testArraySchemaPropertiesMissingInOAS31() throws Exception {
        ...
        // Verify array type
        assertEquals(namesProperty.getType(), "array", "names should be of type array");
        
        // Verify arraySchema properties - THESE ARE CURRENTLY MISSING (BUG)
    ...
    public void testArraySchemaWorksInOAS30() throws Exception {
        ...
        assertEquals(namesProperty.getDescription(), "collection description");
        // Note: In OAS 3.0, 'example' was used instead of 'examples'
        // This test validates the workaround mentioned in the issue
    }
